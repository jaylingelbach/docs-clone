...
export const Avatars = () => {
  return (
    // stops the fullscreen loader from showing while loading avatars
      ...
      <div className="flex items-center">
        {currentUser && (
          <div className="relative ml-2">
            {/* info.avatar set in liveblocks config in root and set in liveblocks prepareSession method */}
